  ...
  <div class="logmod__wrapper">
    ...
    <div class="logmod__container">
      ...
      <div class="logmod__tab lgm-2">
        <div class="logmod__heading">
        <span class="logmod__heading-subtitle" style="color:#F00"><b>Invalid E-mail / Password entered</b></span>
        ...
        <div class="logmod__form">
          <form accept-charset="utf-8" id="loginForm">
            ...
            <div class="simform__actions">
              <button class="sumbit" type="submit" id="loginButton" onclick="loginAction()" value="Log In">Log In</button>
