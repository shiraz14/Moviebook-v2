    ...
    <div class="grid_12">
      ...
      <table border="1">
        <tr>
          ...
          <td width="60"><button type="button" id="loginButton" onclick="loginAction2()">Login</button></td>
        </tr>
      </table>
    </div>
    <div class="clear"></div>
...
<tr><td>Director: Neil Burger; Writer: Evan Daugherty, Vanessa Taylor, Veronica Roth; Stars: Shailene Woodley, Theo James, Ashley Judd</td></tr>
<tr>
<td>
...
<tr><td>Director: Spike Jonze; Writer: Spike Jonze; Stars: Joaquin Phoenix, Amy Adams.</td></tr>
<tr>
<td>
...
<tr><td>Director: Doug Liman; Writers: Christopher McQuarrie (screenplay), Jez Butterworth (screenplay); Stars: Tom Cruise, Emily Blunt, Bill Paxton</td></tr>
<tr>
<td>
...
<tr><td>Director: Gavin Hood; Writers: Gavin Hood (screenplay), Orson Scott Card (based on the book Ender's Game); Stars: Harrison Ford, Asa Butterfield, Hailee Steinfeld</td></tr>
<tr>
<td>
...
<tr><td>Director: Makoto Shinkai; Writers: Clark Cheng (english script), Makoto Shinkai; Stars: Ryûnosuke Kamiki, Mone Kamishiraishi</td></tr>
<tr>
<td>
